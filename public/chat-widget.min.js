class LacoProChat {
    ...
    sanitizeHTML(t) {
        ...
        if (t.includes('+56992322998')) {
            t = t.replace(/\+56992322998/g, '<span class="whatsapp-contact">+56992322998</span>');
            t = t.replace(/https:\/\/wa\.me\/\+56992322998/g, '<a href="https://wa.me/+56992322998" class="whatsapp-link" target="_blank">💬 Contactar por WhatsApp</a>');
        }
        
        // Procesar otros enlaces
        t = t.replace(/(https?:\/\/(?!wa\.me)[^\s]+)/g, url => {
    ...
    async sendMessage() {
        ...
        try {
            ...
            if (['whatsapp', 'wsp', 'contacto', 'numero', 'teléfono', 'telefono'].some(k => t.toLowerCase().includes(k))) {
                this.addMessage("Puedes contactarnos directamente:\n\n+56992322998\n\nhttps://wa.me/+56992322998", "bot");
            } else {
