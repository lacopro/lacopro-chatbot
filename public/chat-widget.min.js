...
this.messagesContainer.appendChild(s),this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight}sanitizeHTML(t) {
    ...
    // Paso 2: Procesar enlaces de WhatsApp
    if (t.includes('+56992322998')) {
        // Reemplazar número de teléfono con formato claro
        t = t.replace(/\+56992322998/g, '<span class="whatsapp-contact">+56992322998</span>');
        
        // Reemplazar enlace de WhatsApp con botón estilizado
        t = t.replace(/https:\/\/wa\.me\/\+56992322998/g, 
