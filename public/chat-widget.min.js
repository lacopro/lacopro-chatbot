...
</div>`,document.body.appendChild(s),this.chatWindow=s,this.messagesContainer=s.querySelector(".tiempoespacio-chat-messages"),this.input=s.querySelector("textarea"),this.sendButton=s.querySelector(".tiempoespacio-chat-input button"),this.closeButton=s.querySelector(".tiempoespacio-chat-close"),this.loading=s.querySelector(".tiempoespacio-chat-loading");

// Inicializar eventos una sola vez
this.chatButton=document.querySelector(".tiempoespacio-chat-button");
