...
this.messagesContainer.appendChild(s),this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight}sanitizeHTML(t){
    // Reemplazar múltiples ocurrencias de "haz clic aquí" con uno solo
    t = t.replace(/haz clic aquí"[^>]+>haz clic aquí/g, 'haz clic aquí');
    
    // Reemplazar el formato de enlace WhatsApp
    t = t.replace(/https:\/\/wa\.me\/\+?\d+/g, url => {
